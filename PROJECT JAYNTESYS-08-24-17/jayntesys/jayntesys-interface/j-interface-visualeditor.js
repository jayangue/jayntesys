...
(function(window){
    function visualeditorfunctions() {
        ...
        f.viewcodestate = function(state) {
            var s = state;
            if (s === "on") {
                visualeditor.viewcodeon = true;
                dom.dl("veditor-viewcodehide");
                dom.uca("BUTTON","veditor-viewcodeshow","Hide Code","veditoroptsholder","onclick","visualeditor.viewcodestate('off');");
                //VIEWCODE = FOR DEBUGGING
                ...
                visualeditor.viewcodeon = false;
                clearInterval(visualeditor.viewcode);
                dom.dl("veditor-inputarea");
                dom.dl("veditor-viewcodeshow");
                dom.uca("BUTTON","veditor-viewcodehide","Show Code","veditoroptsholder","onclick","visualeditor.viewcodestate('on');");
            };
        };      
        f.viewcode = function(){
            if (visualeditor.viewcodeon === true) {
        ...
        f.start = function() {
            ...
            dom.s("feat-ve","backgroundColor","red"); 
            ...
            if (input !== "ERROR ABORT BUILDING") {
                ...
                dom.us("DIV","divvecenter","divveditor"); //Where modules will be located
                dom.ac("divvecenter");
               
                
                //CREATE BUTTONS
                dom.s("divveditoropts","paddingTop","10px");
                dom.uc("P","ve-txt101","Currently No Modules Added","divvecenter");
                dom.uc("P","veditor-mname","Name: ","divveditoropts");
                dom.uca("INPUT","veditor-name","","veditor-mname");
                dom.s("veditor-name","marginBottom","5px");
                ...
                dom.us("BR","","divveditoropts");
                dom.uc("P","veditoroptsholder","","divveditoropts");
                dom.uca("BUTTON","feat-sl","Load/Save","veditoroptsholder","onclick","rfeature.change(3);");
                dom.uca("BUTTON","veditor-removeall","Remove All","veditoroptsholder","onclick","visualeditor.removeall();");
                
                //VIEW CODE FEATURE
                dom.us("BR","","divveditoropts");
                if (visualeditor.viewcodeon === true) {
                    visualeditor.viewcodestate("on");
                }else if (visualeditor.viewcodeon === false) {
                    visualeditor.viewcodestate("off");
                };

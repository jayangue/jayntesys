...
(function(window){
    function interfacefunctions() {
        ...
        f.start = function() {
            ...
            dom.us("DIV","divrstart","divreceive");
    ...
    function rendererfunctions() {
        ...
        f.message = function(id) {
            ...
            switch (id) {
                ...
                break;
                case 3:
                    dom.uc("P","renderer-txt","JAYNTESYS WAS SUCCESFULLY LAUNCHED","divrenderer");
                    dom.uc("P","renderer-txt1","Congratulations!","divrenderer","divrenderer");
                break;
                case 4:

...
(function(window){
    function saveloadfunctions() {
        ...
        f.start = function() {
            ...
            //CREATE TITLE
            dom.uc("P","saveload-title","JAYNTESYS LOAD/SAVE","divsaveload");
            dom.s("saveload-title","margin","10px");
            //MESSAGE
            ...
            dom.uca("BUTTON","saveload-back","Back","divsaveload","onclick","rfeature.change(saveload.prevmain);");
            dom.s("saveload-back","margin","3px");
            //LOAD SAVE REMOVE
            dom.us("DIV","divsaveloadmessage","divsaveload");
